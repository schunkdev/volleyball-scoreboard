  ...
  return (
    ...
    >
      <motion.div 
        ...
        className="glass-panel p-8 rounded-3xl border border-white/10 shadow-2xl min-w-[320px]"
      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-3">
            ...
            <input 
              ...
              autoFocus
              className="w-full bg-surface-variant border-none rounded-2xl px-5 py-4 text-xl font-headline font-bold focus:ring-2 focus:ring-primary outline-none transition-all text-on-surface"
              onKeyDown={(e) => {
                if (e.key === 'Enter') {
                  onConfirm(name, sets);
                  onClose();
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between bg-surface-variant rounded-2xl p-2">
              <button 
                ...
                className="w-12 h-12 flex items-center justify-center rounded-xl hover:bg-white/5 transition-colors text-on-surface"
              >
                <Minus size={20} />
              </button>
              <span className="text-3xl font-headline font-black text-on-surface">{sets}</span>
              <button 
        ...
        <button 
          ...
          className={cn(
            "w-full mt-10 py-5 rounded-2xl font-bold uppercase tracking-[0.2em] text-xs transition-all active:scale-95 shadow-lg",
            color === 'primary' 
